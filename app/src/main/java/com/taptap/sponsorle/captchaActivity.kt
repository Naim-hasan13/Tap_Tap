...
import com.taptap.sponsorle.databinding.ActivityCaptchaBinding
...
class captchaActivity : AppCompatActivity() {
    ...
    private fun checkCaptcha() {
        val input = binding.etEnterCode.text.toString()
        val captureCode = binding.tvCaptcha.text.toString()
        Utils.hideKeyboard(this, binding.etEnterCode)
        if (TinyDB.getString(this, "captcha_limit", "0").toString().toInt() == TinyDB.getString(
                this,
        ...
        if (input == captureCode) {
            ...
            showSnackbar("Incorrect Captcha!")
        ...
        val stringRequest =
            object : StringRequest(Method.POST, url3, { response ->
                ...
                if (res.contains(",")) {
                    ...
                    TinyDB.saveString(this, "captcha_limit", alldata[2])
                ...
                override fun getParams(): Map<String, String> {
                    ...
                    val code = videoplayyer.encrypt("ca".toString(), Hatbc()).toString()
        ...
        AdManagerInterstitialAd.load(
            ...
            object : AdManagerInterstitialAdLoadCallback() {
                ...
                override fun onAdLoaded(interstitialAd: AdManagerInterstitialAd) {
                    ...
                    mAdManagerInterstitialAd?.show(this@captchaActivity)
    ...
    private fun generateCaptureCode() {
        ...
        val randomString = (1..length)
            ...
            .joinToString("")
        binding.tvCaptcha.text = randomString
